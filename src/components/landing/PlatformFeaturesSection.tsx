  ...
  return (
    <section className="py-10 md:py-14 lg:py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div ref={containerRef} className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
          {platformFeatures.map((feature, index) => (
            <div
              key={feature.title}
              className={`
                group relative p-4 md:p-5 lg:p-6 rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm
