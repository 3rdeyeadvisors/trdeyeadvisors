    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <AnimatedSection animation="fade-up" delay={0}>
          <span className="inline-block text-xs md:text-sm uppercase tracking-[0.3em] text-primary font-medium mb-6 md:mb-8">
            DeFi Education Platform
          </span>
        </AnimatedSection>

        <AnimatedSection animation="fade-up" delay={100}>
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-consciousness font-bold text-foreground mb-4 md:mb-6 leading-[1.1] tracking-tight">
            Awaken Awareness.
          </h1>
        </AnimatedSection>

        <AnimatedSection animation="fade-up" delay={200}>
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-consciousness font-bold mb-6 md:mb-10 leading-[1.1] tracking-tight">
        ...
        <AnimatedSection animation="fade-up" delay={300}>
          <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground font-consciousness mb-10 md:mb-12 max-w-2xl mx-auto leading-relaxed">
